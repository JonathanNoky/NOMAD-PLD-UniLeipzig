# NOMAD-PLD-UniLeipzig

Adaption of the PLD process from nomad-material-processing to the needs of Uni Leipzig
...
```sh
git clone https://github.com/JonathanNoky/NOMAD-PLD-UniLeipzig.git
cd NOMAD-PLD-UniLeipzig
